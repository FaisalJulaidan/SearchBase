...
#TheSearchBase_Chatbot .@{calendar-prefix-cls}-range-picker-input {
  width: 44%;
  height: 99%;
  text-align: center;
...
#TheSearchBase_Chatbot .@{calendar-prefix-cls}-range-picker-separator {
...
#TheSearchBase_Chatbot .@{calendar-prefix-cls}-range {
  width: 552px;
  overflow: hidden;
...
#TheSearchBase_Chatbot .@{calendar-prefix-cls}-range.@{calendar-prefix-cls}-show-time-picker {
