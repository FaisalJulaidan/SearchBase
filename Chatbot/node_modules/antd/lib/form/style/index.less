...
#TheSearchBase_Chatbot .@{form-prefix-cls} {
  .reset-component;
  .reset-form;
}

#TheSearchBase_Chatbot .@{form-prefix-cls}-item-required::before {
...
#TheSearchBase_Chatbot .@{ant-prefix}-radio-inline,
#TheSearchBase_Chatbot .@{ant-prefix}-radio-vertical,
#TheSearchBase_Chatbot .@{ant-prefix}-checkbox-inline,
#TheSearchBase_Chatbot .@{ant-prefix}-checkbox-vertical {
  &.disabled {
    cursor: not-allowed;
  }
}
...
#TheSearchBase_Chatbot .@{ant-prefix}-radio,
#TheSearchBase_Chatbot .@{ant-prefix}-checkbox {
  &.disabled {
    label {
      cursor: not-allowed;
    }
...
#TheSearchBase_Chatbot .@{form-prefix-cls}-item {
  label {
    position: relative;
...
#TheSearchBase_Chatbot .@{form-prefix-cls}-explain,
#TheSearchBase_Chatbot .@{form-prefix-cls}-extra {
  clear: both;
...
#TheSearchBase_Chatbot  .@{form-prefix-cls}-text {
  display: inline-block;
  padding-right: 8px;
}

#TheSearchBase_Chatbot  .@{form-prefix-cls}-split {
  display: block;
  text-align: center;
}

// 表单下的输入框尺寸唯一: 大尺寸
#TheSearchBase_Chatbot form {
  .has-feedback {
    .@{ant-prefix}-input {
      padding-right: 24px;
    }
...
#TheSearchBase_Chatbot  .@{ant-prefix}-input-group-wrap {
...
#TheSearchBase_Chatbot .@{form-prefix-cls}-vertical .@{form-prefix-cls}-item-label,
  // when labelCol is 24, it is a vertical form
#TheSearchBase_Chatbot .@{ant-prefix}-col-24.@{form-prefix-cls}-item-label,
#TheSearchBase_Chatbot .@{ant-prefix}-col-xl-24.@{form-prefix-cls}-item-label {
  .make-vertical-layout-label();
}

#TheSearchBase_Chatbot .@{form-prefix-cls}-vertical {
...
//== Inline Form
#TheSearchBase_Chatbot .@{form-prefix-cls}-inline {
  .@{form-prefix-cls}-item {
    display: inline-block;
    margin-right: 16px;
    margin-bottom: 0;
...
// Validation state
#TheSearchBase_Chatbot .has-success,
#TheSearchBase_Chatbot .has-warning,
#TheSearchBase_Chatbot .has-error,
#TheSearchBase_Chatbot .is-validating {
...
#TheSearchBase_Chatbot .@{ant-prefix}-advanced-search-form {
  .@{form-prefix-cls}-item {
    margin-bottom: @form-item-margin-bottom;
