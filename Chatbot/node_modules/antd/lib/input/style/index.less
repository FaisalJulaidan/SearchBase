...
// Input styles
#TheSearchBase_Chatbot .@{ant-prefix}-input {
  .reset-component;
  .input;
}

//== Style for input-group: input with label, with button or dropdown...
#TheSearchBase_Chatbot .@{ant-prefix}-input-group {
  .reset-component;
...
#TheSearchBase_Chatbot .@{ant-prefix}-input-affix-wrapper {
  .reset-component;
...
#TheSearchBase_Chatbot .@{ant-prefix}-input-password-icon {
  cursor: pointer;
  transition: all 0.3s;
  &:hover {
    color: #333;
