...
#TheSearchBase_Chatbot  .@{radio-group-prefix-cls} {
  .reset-component;
...
// 一般状态
#TheSearchBase_Chatbot  .@{radio-prefix-cls}-wrapper {
  .reset-component;
  position: relative;
  display: inline-block;
  margin-right: 8px;
...
#TheSearchBase_Chatbot  .@{radio-prefix-cls} {
  .reset-component;
  position: relative;
  display: inline-block;
  line-height: 1;
...
// 选中状态
#TheSearchBase_Chatbot  .@{radio-prefix-cls}-checked {
...
#TheSearchBase_Chatbot  .@{radio-prefix-cls}-disabled {
  .@{radio-inner-prefix-cls} {
...
#TheSearchBase_Chatbot span.@{radio-prefix-cls} + * {
  padding-right: 8px;
  padding-left: 8px;
}

#TheSearchBase_Chatbot .@{radio-prefix-cls}-button-wrapper {
  position: relative;
  display: inline-block;
