...
#TheSearchBase_Chatbot .@{tab-prefix-cls} {
  .reset-component;
  position: relative;
  overflow: hidden;
  .clearfix;
...
#TheSearchBase_Chatbot .@{tab-prefix-cls}-top .@{tab-prefix-cls}-ink-bar-animated,
#TheSearchBase_Chatbot .@{tab-prefix-cls}-bottom .@{tab-prefix-cls}-ink-bar-animated {
  transition: transform 0.3s @ease-in-out, width 0.3s @ease-in-out, left 0.3s @ease-in-out;
}

#TheSearchBase_Chatbot .@{tab-prefix-cls}-left .@{tab-prefix-cls}-ink-bar-animated,
#TheSearchBase_Chatbot .@{tab-prefix-cls}-right .@{tab-prefix-cls}-ink-bar-animated {
