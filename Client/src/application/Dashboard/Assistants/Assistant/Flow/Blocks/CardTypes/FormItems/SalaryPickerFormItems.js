...
export class MinMaxSalary extends Component {
        ...
        return (
            <div>
                ...
                <FormItem validateStatus={this.state.minMaxValidateStatus}
                          ...
                          {...layout}>
                    <Input.Group compact>
                        <Input onChange={(num) => this.validatePrimeNumber(num, 'minSalary')}
                        ...
                        <Input onChange={(num) => this.validatePrimeNumber(num, 'maxSalary')}
