                            ...
                            <Panel header={<h3>Automatically asks candidates for referral after placement</h3>}
                                ...
                                <FormItem label="Auto refer applicants "
                                    ...
                                    <Switch onChange={e => this.setState({ autoRefer: e })} style={{ marginRight: 15 }}
                                            defaultChecked={this.state.autoRefer}/>
                                </FormItem>
                                ...
                                <>
                                    <FormItem label="Referral Email Title">
                                        <Input placeholder="referral email title"
                                               defaultValue={crmAP.ReferralEmailTitle}
                                               onChange={e => this.setState({ referralEmailTitle: e.target.value })}/>
                                    </FormItem>
                                    ...
                                    <Row className={styles.CEKwrapper}>
                                        ...
                                        <ButtonGroup style={{ margin: '5px 0' }}>
                                            <Button
                                                onClick={() => this.setState({ referralEmailBody: this.state.referralEmailBody + ' ${candidateName}$' })}>
                                                Candidate Name
                                            </Button>
                                            <Button
                                                onClick={() => this.setState({ referralEmailBody: this.state.referralEmailBody + ' ${candidateEmail}$' })}>
                                                Candidate Email
                                            </Button>
                                        </ButtonGroup>
                                        <Row>
                                ...
                                <Row className={styles.CEKwrapper}>
                                    ...
                                    <ButtonGroup style={{ margin: '5px 0' }}>
                                        <Button
                                            onClick={() => this.setState({ referralSMSBody: this.state.referralSMSBody + ' ${candidateName}$' })}>
                                            Candidate Name
                                        </Button>
                                        <Button
                                            onClick={() => this.setState({ referralSMSBody: this.state.referralSMSBody + ' ${candidateEmail}$' })}>
                                            Candidate Email
                                        </Button>
                                    </ButtonGroup>
