            ...
            <div className={styles.desc_wrapper}>
                <Row>
                    <Col xs={{span: 8, offset: 2}}>
                        <h1>In-House</h1>
                        <p>At SearchBase, our customers tell us they want us to be a strategic partner, not a transactional vendor. They want us to apply our fully specialised solutions to help them meet their goals. And we do.
                        </p>
                    </Col>
                </Row>
                <Row>
                    ...
                    <Col xs={{span:8,offset:2}}>
                        <Card className={styles.card}>
                            <Card.Body className={styles.product_card_body}>
                                ...
                                <Link to="/how-it-works#chatbot">learn more<FontAwesomeIcon className={styles.icon} icon={faChevronRight}/>
                                </Link>
                            </Card.Body>
                        </Card>
                    </Col>
