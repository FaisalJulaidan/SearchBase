...
export const http = axios.create({
    baseURL: `${process.env.REACT_APP_ENV !== "development"? process.env.API_URL:''}/api`,
    ...
    error => {
        ...
        if (error.config && error.response) {
            ...
            if (error.response.status === 401) {
                ...
                // get new token
                return axios.post(`${process.env.REACT_APP_ENV !== "development"? process.env.API_URL:''}/api/auth/refresh`, null, {
                    headers: {
