...
// Save Campaign
const saveCampaign = (name, assistant_id, use_crm, crm_id, shortlist, database_id, messenger_id, location, jobTitle, skills, message) => ({
...
// Update Campaign
const updateCampaign = (campaignID, name, assistant_id, use_crm, crm_id, shortlist, database_id, messenger_id, location, jobTitle, skills, message) => ({
...
const fetchCampaignCandidatesData = (assistant_id, use_crm, crm_id, shortlist, database_id, messenger_id, location, jobTitle, jobType, skills, text, outreach_type, email_title) => ({
...
// Launch Campaign
const launchCampaign = (assistant_id, use_crm, crm_id, shortlist, database_id, messenger_id, location, jobTitle, jobType, skills, text, candidate_list, outreach_type, email_title) => ({
