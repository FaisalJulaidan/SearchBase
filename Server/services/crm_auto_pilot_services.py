...
def updateConfigs(id, name, desc, refer, referralAssistantID, referralEmailTitle, referralEmailBody, referralSMSBody, sendReferralEmail, sendReferralSMS, companyID: int) -> Callback:
    try:
        ...
        crmAutopilot.AutoReferApplicants = refer
