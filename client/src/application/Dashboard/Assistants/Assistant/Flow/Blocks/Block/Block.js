...
class Block extends Component {
    ...
    render() {
        const {block, databaseOptions} = this.props;
                ...
                <Panel header={(
                    ...
                    {block.Content.databaseID ?
                        <Row>
                            ...
                            <Col
                                span={12}>{databaseOptions.databaseTypes?databaseOptions.databaseTypes.find(databaseType => databaseType === block.Content.databaseType):null}</Col>
                            <Divider/>
                        </Row>
                        : null
                    }
