                        ...
                        <div className={styles.Panel}>
                            ...
                            <div className={styles.Panel_Body}>
                                ...
                                <Tabs defaultActiveKey="1" activeKey={this.state.currentKey} tabBarStyle={{display:"none"}}>
                                    <TabPane key="1">
                                        As a platform, we have divided Admin Panel into three multiple sections which allow for the ease of accessibility.<br /><br />
                                        Dashboard<br /><br />
                                        Assistants<br /><br />
                                        Account<br /><br />
                                        <br />
                                        ...
                                        Account: The Account's page can be used to make changes to your account and control your details.<br /><br />
                                    </TabPane>
                                    ...
                                    <TabPane key="6">
                                        ...
                                        You should then:<br />
                                        Give your Assistant a name<br />
                                        A welcome message<br />
                                        A title (this will appear at the top of the chatbot)<br />
                                        How long before it automatically opens a conversation (switch off if you wish to keep it silent)<br />
                                        A template (if you wish to create it from a template)<br />
                                    ...
                                    <TabPane key="7">
                                        If you wish to use your Assistant for specific task, such as showing candidates job opportunities, or showing clients candidate profiles then you can very easily connect your live data to the chatbot.<br />
                                    ...
                                    <TabPane key="10">
                                        ...
                                        Template Formats<br />
                                        We have several template formats that are best suited for certain environments.<br />
                                        General Front-website<br />
                                        Specific Front-Website<br />
                                        Joining Us<br />
                                        Re-recruiting old clients<br />
                                        Candidate experience<br />
                                        Pre-screening confirmation<br />
                                        Candidates with clients<br />
                                        Template Conversations<br />
