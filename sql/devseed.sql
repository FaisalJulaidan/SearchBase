...
INSERT INTO Users(ID, CompanyID, Firstname, Surname, AccessLevel, Email, Password, StripeID, Verified) VALUES (1, 1, 'John', 'Smith', 'Admin', 'test@test.test', '?', 'cus_D3qdko6i2SfRLE', 'True');
