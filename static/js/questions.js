...
var qTemplate2 = " question <span class=\"required\">*</span></label><div class=\"col-md-6 col-sm-6 col-xs-12\"><input type=\"text\" name=\"last-name\" required=\"required\" class=\"form-control col-md-7 col-xs-12\"></input></div><br /><br /></div>";
    ...
    if(noq <= maxQuestions){
      if(noq > oldNOQ){
        for(i = oldNOQ; i < noq; i++){
          ...
          if(i == 8){ number = "Ninth" }
          if(i == 9){ number = "Tenth" }
          $("#QuestionDiv").append(qTemplate1 + number + qTemplate2);
